                        ...
                        <div class="row inactive">
                            <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12 safecheck">
                                <div class="analytics-sparkle-line reso-mg-b-30 accommodations">
                                    <a class="accommodation-status" href="<?php echo base_url('admin/accommodations/active'); ?>">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12 safecheck">
                                <div class="analytics-sparkle-line reso-mg-b-30 accommodations">
                                    <a class="accommodation-status" href="<?php echo base_url('admin/accommodations/inactive'); ?>">
                                        <div class="analytics-content">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12 ">
                                <div class="col-lg-12  col-xs-12 safecheck acticheck">
                                    <div class="analytics-sparkle-line1 reso-mg-b-30 ">
                                        <a class="accommodation-status" href="<?php echo base_url('admin/checkins'); ?>">
                                            <div class="analytics-content">
                                    ...
                                    <hr/>
                                    <div class="analytics-sparkle-line1 reso-mg-b-30 ">
                                        <a class="accommodation-status" href="<?php echo base_url('admin/visitors'); ?>">
                                            <div class="analytics-content">
                                ...
                                <div class="col-lg-12  col-xs-12 safecheck checktoday">
                                    <div class="analytics-sparkle-line1 reso-mg-b-30 ">
                                        ...
                                        <div class="todayreports">
                                            <a href="<?php echo base_url('admin/visitors/filter?start_date='.date('Y-m-d').'&end_date='.date('Y-m-d'));?>">Today Reports</a>
                                        </div> 
                                    </div>
                                    <hr/>
                                    <div class="analytics-sparkle-line1 reso-mg-b-30 ">
    ...
    <div class="container-fluid">
        <div class="row allaccom">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 accomudation">
                ...
                <div class="white-box">
                    <div class="static-table-list">
                        <p class="zoro"><a href="#"><?php echo $sos; ?></a></p>
                        <?php if($sos == 0){?>
                            <p>NO SoS Found</p>
                        <?php } ?>
                    </div>
...
<script>
    ...
    function initialize() {
    var mapOptions = {
        center: new google.maps.LatLng(20.049159,64.4018361),
        zoom: 0,
        mapTypeId: 'roadmap',
    };
