                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?php echo base_url('admin/login'); ?>" id="loginForm" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" data-mask="9999999999" title="Please enter you phone number" required name="phone_number" id="phone_number" class="form-control" autofocus>
                                    <?php echo (form_error('phone_number') != '') ? "<div class='alert alert-danger' role='alert'>" . form_error('phone_number') . "</div>" : NULL;?>
                                </div>
                                <button type="submit" name="submit" value="sendOTP" class="btn btn-success btn-block loginbtn">Send OTP</button>
                            </form>
                        </div>
                    </div>
                </div>
