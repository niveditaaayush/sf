                            ...
                            <?php if(@sizeof($suspects) > 0){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger actions delete" href="<?php echo base_url('admin/suspects/delete/'. base64_encode($value->id));?>"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php }
                             }?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#add_suspect').on('click', function(){
            var url = '<?php echo base_url('admin/suspects'); ?>';
        ...
        $('.user-edit-icon').on('click', function(){
            ...
            var url = '<?php echo base_url('admin/suspects/update/');?>';
