...
<div class="login-horizental lg-hz-mg"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Submit</button></div>
    ...
    <div class="breadcome-list">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
                <div class="row accom checkactiv">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h5>Checkins</h5>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="white-box">
            <div class="static-table-list">
                <table class="table">
                    ...
                    <tbody>
                    <?php if (@sizeof($accommodationsTypes) > 0) {
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBIfmyKjw_HfGPCNSwmZmfv8gasWDNVyL8&callback=initMap"></script>
