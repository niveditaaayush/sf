                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                    <h1 class="reportaccommo">Accommodations <span class="table-project-n">Report</span></h1>
                                </div>
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                    <a class="btn btn-sm btn-primary full-checkins" href="<?php echo base_url('admin/accommodations/'.$endPoint);?>">export</a>
                                </div>
                            </div>
                        </div> 
                        <div class="sparkline13-graph">
                            ...
                            <table id='accommodationsReport' class='display dataTable'>
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Name</th>
                                ...
                                <?php if(@sizeof($accommodations) > 0){
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url('admin/accommodations/profile/'.base64_encode($accommodation->id));?>" class=""><?php echo $accommodation->name;?></a></td>
