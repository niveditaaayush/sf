                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form action="<?php echo base_url('admin/accommodations/edit/' . base64_encode($accommodation->id)); ?>" method="post" enctype="multipart/form-data">
...
<?php echo (form_error('accommodation_photo') != '') ? "<div class='alert alert-danger' role='alert'>" . form_error('accommodation_photo') . "</div>" : NULL; ?>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <input type="text" name="noOfRooms" class="form-control" placeholder="No Of Rooms" value="<?php echo $accommodation->noOfRooms ? $accommodation->noOfRooms : ''; ?>" readonly />
