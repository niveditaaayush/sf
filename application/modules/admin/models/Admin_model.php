...
class Admin_model extends CI_Model {
    protected $tablename = 'vms19_administration';
    protected $suspectTablename  = 'vms19_suspects';
    ...
    public function storeSuspectInfo($params) {
        ...
        return $this->store($this->suspectTablename, $params);
    }

    public function getAdminInfo($aWhere) {
        if ( ! is_array($aWhere) || empty($aWhere)) {
            return array();
        }
    ...
    public function storeAdminInfo($params) {
        if ( ! is_array($params) || empty($params)) {
            return FALSE;
        }
