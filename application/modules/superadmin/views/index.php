                            ...
                            <div class="basic-login-form-ad">
                                <div class="row">
                                    ...
                                    <div class="basic-login-inner inline-basic-form">
                                        <form action="<?php echo base_url('superadmin/dashboard/filter'); ?>" method="get">
                        ...
                        <div class="row checkactiv">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="view-details viewcheck">
                                    <a href="<?php echo base_url('superadmin/visitors'); ?>">View Checkins</a>
                                </div> 
                            </div>
                        </div>
                        <div class="row check">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#city').on('change', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>superadmin/dashboard/getAjaxSHOAreaList',
                data: {'city': city}
        ...
        $('#sho_area').on('change', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>superadmin/dashboard/getAjaxZonesList',
