...
class Accommodations extends MX_Controller {
    ...
    function __construct() {
        ...
        $this->current_url = base_url('superadmin/accommodations');
    }
    ...
    public function index() {
        ...
        $data['accommodations'] = $this->accommodations_model->getAllAccommodationsWithLiveCheckins();
    ...
    private function updateAccommodation($id) {
