                ...
                <div class="breadcome-list single-page-breadcome">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                            <a class="backUser btn btn-sm btn-primary login-submit-cs" style="position: absolute;top: 5px;right: 90px;" href="<?php echo base_url('superadmin/accommodations/edit/'.base64_encode($accommodation->id));?>">Edit</a>
