...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#district').on('change', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url();?>superadmin/dashboard/getAjaxDistrictZones',
        ...
        $('#zone').on('change', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>superadmin/dashboard/getAjaxZoneDivisions',
                data: {'zone': zone}
            }).done(function (response) {
                var data = JSON.parse(response);
                $('select#division').html('<option value="">Select Division</option>');
        ...
        $('#division').on('change', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>superadmin/dashboard/getAjaxDivisionSHOArea',
