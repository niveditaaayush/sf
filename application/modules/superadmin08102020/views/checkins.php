                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <ul class="breadcome-menu">
                                <li>
                                    <a href="<?php echo base_url('superadmin/dashboard'); ?>">Safe CheckIn</a> <span class="bread-slash">></span>
                                </li>
                                <li>
                        ...
                        <div class="main-sparkline13-hd">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-right">
                                    <a class="btn btn-sm btn-primary full-checkins" href="<?php echo base_url('superadmin/checkins');?>">Active Checkins</a>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-sm btn-primary full-checkins" href="<?php echo base_url('superadmin/checkins/allExport/'.$get_params);?>">export</a>
                                </div>
                                <?php } else {?>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-right">
                                    <a class="btn btn-sm btn-primary full-checkins" href="<?php echo base_url('superadmin/checkins/all');?>">All Checkins</a>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-sm btn-primary full-checkins" href="<?php echo base_url('superadmin/checkins/activeExport/'.$get_params);?>">export</a>
                                </div>
                                <?php }?>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row fullreport">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="basic-login-inner inline-basic-form">
                                                <form action="<?php echo base_url('superadmin/checkins/filter'); ?>" method="get">
                                            ...
                                            <tr>
                                                ...
                                                <td class="visitorsImages" style="width:200px;">
                                                    <p class="view-details">
                                                        <a href="<?php echo base_url('superadmin/checkins/details/'. base64_encode($visitor->primaryId));?>">View Details</a>
                                                    </p>
                                                    <p class="view-details">                                                        
                                                        <a href="<?php echo base_url('superadmin/checkins/past/'. base64_encode($visitor->primaryId));?>">Past Checkins</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        <?php }
